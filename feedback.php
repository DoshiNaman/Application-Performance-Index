    ...
    <div class="container mt-5 mb-5 rounded shadow-lg base">
      ...
      <div class="d-flex justify-content-center align-items-center">
        <div class="blackboard">
          <h3 class="text-center p-3 fbtitle">
            Give Feedback For This Application
          </h3>
          <form class="p-1">
            <div class="row mb-3">
              <label for="inputEmail3" class="col-sm-2 col-form-label fblabel"
                >Name:</label
              >
              <div class="col-sm-10">
                <input type="text" id="inputEmail3" class="fbi" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="inputEmail3" class="col-sm-2 col-form-label fblabel"
              ...
              >
              <div class="col-sm-10">
                <input type="email" id="inputEmail3" class="fbi" />
              </div>
            </div>
            <div class="row mb-3">
              <label
                for="inputPassword3"
                class="col-sm-2 col-form-label fblabel"
                >Feedback:</label
              >
              <div class="col-sm-10">
                <textarea
