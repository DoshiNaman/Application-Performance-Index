...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5 mb-5 rounded shadow-lg base">
      <?php
        if($_SESSION['dprofile']==0){
          echo '<nav class="navbar navbar-expand-lg blurrr">';
        }
        else if($_SESSION['dprofile']==1){
                ...
                while($row = mysqli_fetch_assoc($result)) {
                  ...
                  <img src="../../document/'.$a.'/'.$row["dp"].'" class="img-thumbnail mb-3">
                    <div class="input-group mb-3">
                      <span class="input-group-text">🧑‍🏫</span>
                      <div class="form-floating">
                      <input type="text" name="title" class="form-control" id="fnameType" placeholder="test" value="'.$row['name'].'">
                    ...
                    <div class="input-group mb-3">
                      <span class="input-group-text">😁</span>
                      <div class="form-floating">
                      <input type="text" name="dept" class="form-control" id="fnameType" placeholder="test" readonly value="'.$row['dept'].'">
                    ...
                    <div class="input-group mb-3">
                      <span class="input-group-text">😇</span>
                      <div class="form-floating">
                      <input type="text" name="role" class="form-control" id="mnameType" maxlength="1" placeholder="test" readonly value="'.$row['role'].'">
                    ...
                    <div class="input-group mb-3">
                      <span class="input-group-text pt-3 pb-3">📄</span>
                      <span class="input-group-text pt-3 pb-3">Avatar&nbsp;<i>(Only Image)</i></span>
                      <input type="file" name="attachment" accept="image/png, image/jpg, image/jpeg" class="form-control pt-3 pb-3" id="image">
                    </div>
